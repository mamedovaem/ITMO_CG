...
RECT Viewport::ComputeDisplayArea(DXGI_SCALING scaling, int backBufferWidth, int backBufferHeight, int outputWidth, int outputHeight) noexcept
{
    RECT rct = {};
...
RECT Viewport::ComputeTitleSafeArea(int backBufferWidth, int backBufferHeight) noexcept
{
