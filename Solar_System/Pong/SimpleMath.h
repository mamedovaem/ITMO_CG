...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        public:
            ...
            static RECT __cdecl ComputeDisplayArea(DXGI_SCALING scaling, int backBufferWidth, int backBufferHeight, int outputWidth, int outputHeight) noexcept;
        #endif
            static RECT __cdecl ComputeTitleSafeArea(int backBufferWidth, int backBufferHeight) noexcept;
        };
